        ...
        for (j = 0; j < CHUNKS; j++) begin : gen_cols
            ...
            if (j == 0) begin : g_pe_rightmost
                pe_rightmost_var #(
                    ...
                    .a_in (a_shift[i]),
                    .b0_in(i == 0 ? b_shift[j] : b_delay[i == 0 ? 0 : i-1][j]),

                    .np_in(i == 0 ? n_prime : pe_np_out[i == 0 ? 0 : i-1][j]),
                    .s_in (i == 0 ? '0 : pe_s_out[i == 0 ? 0 : i-1][1]),
                    .n_in (i == 0 ? modulus[0] : pe_n_out[i == 0 ? 0 : i-1][j]),
                ...
                pe_standard_var #(
                    ...
                    .a_in(pe_a_out[i][j-1]),
                    .b_in(i == 0 ? b_shift[j] : b_delay[i == 0 ? 0 : i-1][j]),
                    .q_in(pe_q_out[i][j-1]),

                    .c_in(pe_c_out[i][j-1]),
                    .s_in(i == 0 ? '0 : c_delay[i == 0 ? 0 : i-1]),
                    .n_in(i == 0 ? modulus[j] : pe_n_out[i == 0 ? 0 : i-1][j]),
                ...
                pe_standard_var #(
                    ...
                    .s_in(i == 0 ? '0 : (2 * W)'(pe_s_out[i == 0 ? 0 : i-1][j+1])),
                    .n_in(i == 0 ? modulus[j] : pe_n_out[i == 0 ? 0 : i-1][j]),
