package instr_pkg;
    ...
    // Bank 1
    localparam operand_t X2 = '{is_init: 1'b1, bank: 2'd1, idx: 3'd0};
    localparam operand_t Y1 = '{is_init: 1'b1, bank: 2'd1, idx: 3'd1};
    localparam operand_t ZZZ1 = '{is_init: 1'b1, bank: 2'd1, idx: 3'd2};
